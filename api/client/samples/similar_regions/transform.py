...
def _impute(no_of_points, period_length_days, start_datetime, pulled_dataset):
    x_output = np.arange(0, period_length_days * no_of_points, period_length_days)

    x_input = []
    y_input = []

    no_valid_points_pulled_dataset = 0
