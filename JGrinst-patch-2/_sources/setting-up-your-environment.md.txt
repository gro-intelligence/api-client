...
3. Install both Python and pip to PATH either in the installer (enable component during the installation) or manually. The easiest way to do this is to make sure the below is checked during installation: ![readme_add_python_to_path_installer](https://github.com/gro-intelligence/api-client/blob/development/readme_add_python_to_path_installer.png)
