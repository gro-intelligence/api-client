...
V2_DATA_DESCRIPTION_KEY = "series_description"
V2_DATA_DESCRIPTION_COLS = [
    [V2_DATA_DESCRIPTION_KEY, x] for x in DATA_SERIES_UNIQUE_TYPES_ID
] + [[V2_DATA_DESCRIPTION_KEY, "unit_id"]]
