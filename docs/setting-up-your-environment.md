...
![user-profile-annotated.png](/docs/media/user-profile-annotated.png)

2. In the Account menu, select the API tab (see below).
![profile-tab-annotated.png](/docs/media/profile-tab-annotated.png)

3. Select the text of the token and copy it to your clipboard, or use the "copy to clipboard" button (see below).
![api-tab-annotated.png](/docs/media/api-tab-annotated.png)
...
![regenerate-token.png](/docs/media/regenerate-token.png)
